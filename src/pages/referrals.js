...
<div style={{width:'7px', height:'7px', borderRadius:'3.5px', background:'#31C6AC', marginRight:'11px'}}>
  ...
  <div  id="early" className="inputbox" style={{width:'423px',maxWidth:'150%',  minHeight:'58px', height:'auto', borderRadius:'15px', border:'1px solid #31C6AC',boxSizing:'border-box', padding:'0 11px',
